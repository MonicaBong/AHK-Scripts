...
;;---------------------Programme execution tray-------------;;


`:: send #d
1:: 
IfWinNotExist, ahk_exe Far.exe
	Run, C:\Users\hk\Documents\Pirogram for CP\Far Manager\Far.exe              ;For running Far MAnager 
...
IfWinNotExist, ahk_class Chrome_WidgetWin_1
	Run, chrome.exe
if WinActive("ahk_class Chrome_WidgetWin_1")                                    ; For activating Chrome or Chrome like windows
	Send ^{tab}                                            ;Switches through tabs
else
...
IfWinNotExist, ahk_exe Notion.exe
	Run, C:\Users\hk\Desktop\Notion.lnk                  ; Opens notion via a shortcut on the Desktop
...
IfWinNotExist, ahk_class CabinetWClass
	Run, explorer.exe
GroupAdd, vaults, ahk_class CabinetWClass                 ; Opens and switches through the explorer windows strrting with the most recent ones
if WinActive("ahk_exe explorer.exe")
	GroupActivate, vaults, r
else
...
ControlFocus, ComboBox1, Save As
send, Text.txt
return
n:: send, ^+n
m::send ^+m
...
numpad1::
if WinActive("ahk_class Chrome_WidgetWin_1")
	send ^+{tab}   ;goto the previous tab
return

numpad2::
if WinActive("ahk_class Chrome_WidgetWin_1")
	send ^{tab}   ;goto the next tab
return
...
+t:: run, C:\Users\hk\Desktop\TT Sem1.jpg
